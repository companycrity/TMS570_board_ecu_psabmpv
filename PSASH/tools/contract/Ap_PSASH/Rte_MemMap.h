...
#   error "The magic number of the generated file <C:/Sankar/New_EA3_Database/Working/PSASH/tools/contract/Ap_PSASH/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
