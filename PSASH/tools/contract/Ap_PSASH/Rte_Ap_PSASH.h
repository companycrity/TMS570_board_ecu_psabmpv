...
# define Rte_InitValue_APAState_Cnt_u08 ((UInt8)0u)
# define Rte_InitValue_APAStateTransitionCause_Cnt_u08 ((UInt8)0u)
...
# define Rte_InitValue_AssistStallLimit_MtrNm_f32 ((Float)0)
...
# define Rte_IRead_PSASH_Per1_PosSrvoNTC_Cnt_lgc() \
  (Rte_Inst_Ap_PSASH->PSASH_Per1_PosSrvoNTC_Cnt_lgc->value)
...
# define Rte_IWrite_PSASH_Per1_APAStateTransitionCause_Cnt_u08(data) \
  ( \
  Rte_Inst_Ap_PSASH->PSASH_Per1_APAStateTransitionCause_Cnt_u08->value = (data) \
  )

# define Rte_IWriteRef_PSASH_Per1_APAStateTransitionCause_Cnt_u08() \
  (&Rte_Inst_Ap_PSASH->PSASH_Per1_APAStateTransitionCause_Cnt_u08->value)

# define Rte_IWrite_PSASH_Per1_APAState_Cnt_u08(data) \
  ( \
  Rte_Inst_Ap_PSASH->PSASH_Per1_APAState_Cnt_u08->value = (data) \
  )

# define Rte_IWriteRef_PSASH_Per1_APAState_Cnt_u08() \
  (&Rte_Inst_Ap_PSASH->PSASH_Per1_APAState_Cnt_u08->value)
...
#    error "The magic number of the generated file <C:/Sankar/New_EA3_Database/Working/PSASH/tools/contract/Ap_PSASH/Rte_Ap_PSASH.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
