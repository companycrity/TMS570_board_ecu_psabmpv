...
#   error "The magic number of the generated file <C:/Sankar/Synergy/Working/PSATA-pznywf/PSATA/tools/contract/Ap_PSATA/Rte_MemMap.h> is different. Please check time and date of the generated RTE files!"
#  endif
# else
