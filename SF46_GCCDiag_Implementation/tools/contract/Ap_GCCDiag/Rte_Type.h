...
struct Rte_CDS_Ap_GCCDiag
{
  /* Data Handles section */
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_GCCDIAG_APPL_VAR) GCCDiag_Per1_DftGrossCCDiag_Cnt_lgc;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_GCCDIAG_APPL_VAR) GCCDiag_Per1_HwTorque_HwNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_GCCDIAG_APPL_VAR) GCCDiag_Per1_MRFMtrTrqCmdScl_MtrNm_f32;
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_GCCDIAG_APPL_VAR) GCCDiag_Per1_VehicleSpeed_Kph_f32;
...
extern CONSTP2CONST(struct Rte_CDS_Ap_GCCDiag, RTE_CONST, RTE_CONST) Rte_Inst_Ap_GCCDiag;
...
#    error "The magic number of the generated file <C:/_00_Working_Files/_19_EA3.0_Work/03_Component_Development/_NewProcess/_01_SF46/SF46_GCCDiag_Implementation/tools/contract/Ap_GCCDiag/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
