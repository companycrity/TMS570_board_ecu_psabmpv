...
#    error "The magic number of the generated file <C:/synergy_projects_working/PSA/PSA_BMPV_EPS_TMS570/SwProject/SrlComInput/utp/contract/Ap_SrlComInput/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
