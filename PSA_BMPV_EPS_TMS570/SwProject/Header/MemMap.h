 ...
 * --------  -------  --------  ------------------------------------------------------------------------------  -------
 * 02/17/14   1       OT        Initial version
 * 05/20/14   2       OT        Updates for DigMSB v6
 * 07/14/14   3       OT        Removed Metrics
 * 07/16/14   4       OT        Integrated Dma
 * 07/24/14   5       OT        Integrated latest HwPwUp
 * 08/11/14   6       OT        Updates for new bootloader design
 * 08/22/14   7       OT        Updates for new MPU layout                                                       12249
 * 09/10/14   8       OT        Integrated GCCDiag                                                               12254
 * 09/10/14   9       OT        Integrated latest VehDyn                                                         12364
 * 09/11/14  10       OT        Updates to DiagSvc for new DSR                                                   12451
 * 09/16/14  11       OT        Integrated PosServo                                                              12259
 * 10/02/14  12       OT        Updates to AppDesc and CDDInterface                                              12363
 * 10/15/14  13       OT        Updates to VehPwrMd                                                              12539
 * 10/21/14  14       OT        Implemented tune-on-the-fly                                                      12266
 * 10/22/14  15       OT        Integrated CustBattDiag                                                          12267
 * 10/23/14  16       OT        Added DfltConfigData deprecated blocks for NvM safety update                     12252
 * 11/10/14  17       OT        Integrated FaultLog                                                              12365
 * 11/24/14  18       OT        Updates for Polyspace                                                            12754
 * 06/15/15  19       OT        Updates to ePWM and NHET                                                         13430
 * 07/09/15  20       OT        Updates for DemIf                                                                13470
 * 07/22/15  21       OT        Integrated PSASH and PSATA                                                       13493
 * 10/20/15  22       OT        Integrated latest Dma and uDiag                                               EA3#3484
 * 05/18/16  25       WH        Integrated latest PSASH                                                          EA3#8384
 * 05/20/16  26       WH        Updated memory region workaround after psash fix                                 EA3#8384
 */
/**********************************************************************************************************************
*  INCLUDES
**********************************************************************************************************************/
...
#ifdef CDDINTERFACE9_START_SEC_VAR_NOINIT_32
	#undef CDDINTERFACE9_START_SEC_VAR_NOINIT_32
	#define START_SEC_VAR_ZERO_INIT_32BIT_9
#endif
...
#ifdef GCCDIAG_START_SEC_VAR_CLEARED_16
	#undef GCCDIAG_START_SEC_VAR_CLEARED_16
	#define START_SEC_VAR_ZERO_INIT_16BIT_9
#endif
#ifdef GCCDIAG_STOP_SEC_VAR_CLEARED_16
	#undef GCCDIAG_STOP_SEC_VAR_CLEARED_16
	#define STOP_SEC_VAR
#endif

#ifdef GCCDIAG_START_SEC_VAR_CLEARED_UNSPECIFIED
	#undef GCCDIAG_START_SEC_VAR_CLEARED_UNSPECIFIED
	#define START_SEC_VAR_ZERO_INIT_UNSPECIFIED_9
#endif
#ifdef GCCDIAG_STOP_SEC_VAR_CLEARED_UNSPECIFIED
	#undef GCCDIAG_STOP_SEC_VAR_CLEARED_UNSPECIFIED
	#define STOP_SEC_VAR
#endif
