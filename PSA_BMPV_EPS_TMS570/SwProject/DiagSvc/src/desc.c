/* -----------------------------------------------------------------------------
  ...
  Description: Implementation of CANdesc.
                ...
                Manufacturer: PSA
                EcuDocFile:   C:\synergy_projects\PSA\PSA_BMPV_EPS_TMS570\Tools\AsrProject\Config\System\PSA_BMPV.cdd
                Variant:      CommonDiagnostics

  Generated by CANdelaGen, Thu Sep 15 16:24:20 2016
...
#define DESC_IMPLEMENTATION_MAGIC_NUMBER                             12262
...
#define kDescNrcRejectStateSession                                   kDescNrcServiceNotSupportedInActiveSession
...
/* SvcHead table size. */
#define kDescSvcHeadNumItems                                         13
/* SvcInst table size. */
#define kDescSvcInstNumItems                                         79
/* SvcInstHeadEx table size. */
#define kDescSvcInstHeadExtNumItems                                  160
/* Context modes */
...
V_MEMROM0 static V_MEMROM1 DescMsgItem V_MEMROM2 g_descSidMap[kDescSvcIdMapSize] = 
{
  ...
  0xFF, 0x09, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x0A, 0xFF, 
...
V_MEMROM0 static V_MEMROM1 DescSvcHead V_MEMROM2 g_descSvcHead[kDescSvcHeadNumItems] = 
{
  ...
  { 0x01, 1, 1, 0x01, 0x01, 1, 1, 1, 1, 0x0E, 0x00,  2,  5,  5 } /* $11 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0, 0x0D, 0x00,  1,  9,  9 } /* $14 */, 
  { 0x01, 1, 1, 0x03, 0x03, 0, 1, 1, 1, 0x0D, 0x00,  2, 10,  9 } /* $19 */, 
  { 0x01, 0, 0, 0x03, 0x03, 0, 1, 0, 0, 0x1F, 0x00,  1, 13, 12 } /* $22 */, 
  { 0x01, 1, 1, 0x01, 0x01, 1, 1, 1, 1, 0x0E, 0x00,  2, 14, 12 } /* $27 */, 
  { 0x05, 2, 1, 0x03, 0x03, 1, 0, 1, 1, 0x0C, 0x00,  3, 18, 16 } /* $28 */, 
  { 0x07, 2, 2, 0x01, 0x01, 0, 1, 0, 0, 0x0F, 0x00,  4, 20, 22 } /* $2E */, 

  { 0x07, 3, 3, 0x01, 0x01, 0, 1, 0, 1, 0x08, 0x00,  4, 53, 88 } /* $2F */, 
  { 0x0D, 3, 3, 0x01, 0x01, 1, 1, 0, 1, 0x0C, 0x00,  4, 57, 100 } /* $31 */, 
  { 0x01, 1, 1, 0x03, 0x03, 1, 1, 1, 1, 0x1F, 0x00,  2, 76, 157 } /* $3E */, 
  { 0x01, 1, 1, 0x03, 0x01, 1, 1, 1, 1, 0x0C, 0x00,  2, 77, 158 } /* $85 */, 
  { 0x00, 0, 0, 0x00, 0x00, 0, 1, 0, 0, 0x00, 0x00,  1, 79, 160 } /* $FF */
};
...
{
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x07 },                      0,    0, DescOemControlDefault_Session } /* $10 $1 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x07 },                      1,    0, DescOemControlProgramming_Session } /* $10 $2 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x07 },                      2,    0, DescOemControlExtended_Diagnostic_Session } /* $10 $3 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x07 },                      3,    0, DescOemControlRemote_Access_Session } /* $10 $50 */, 
  {   2, { 0x01, 0x01, 0 }, { 0x1D, 0x07 },                      4,    0, DescOemControlNexteer_Session } /* $10 $7E */, 
  {   2, { 0x01, 0x01, 0 }, { 0x0E, 0x07 }, kDescStateNoTransition,    1, ApplDescECUResetHardReset } /* $11 $1 */, 
  {   2, { 0x01, 0x01, 0 }, { 0x0E, 0x07 }, kDescStateNoTransition,    2, ApplDescECUResetKeyOffOnReset } /* $11 $2 */, 
  {   2, { 0x01, 0x01, 0 }, { 0x0E, 0x07 }, kDescStateNoTransition,    3, ApplDescECUResetSoftReset } /* $11 $3 */, 

  {   2, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescECUResetNexteerReset } /* $11 $60 */, 
  {   4, { 0x03, 0x03, 0 }, { 0x0D, 0x07 }, kDescStateNoTransition,    6, ApplDescClearFaultMemory } /* $14 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x0D, 0x07 }, kDescStateNoTransition,    0, ApplDescRead_Number_of_DTC_By_StatusMaskFaultMemory } /* $19 $1 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x0D, 0x07 }, kDescStateNoTransition,    0, ApplDescRead_by_MaskFaultMemory } /* $19 $2 */, 
  {   6, { 0x03, 0x03, 0 }, { 0x0D, 0x07 }, kDescStateNoTransition,    0, ApplDescRead_DTC_Snapshot_Data_by_DTC_NumberFaultMemory } /* $19 $4 */, 
  {   0, { 0x03, 0x03, 0 }, { 0x1F, 0x07 }, kDescStateNoTransition,    5, DescReadDataByIdentifier } /* $22 */, 
  {   2, { 0x01, 0x01, 0 }, { 0x0E, 0x07 }, kDescStateNoTransition,    0, ApplDescSecurityAccessRequestSeed } /* $27 $1 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x0E, 0x07 },                      5,    0, ApplDescSecurityAccessSendKey } /* $27 $2 */, 

  {   2, { 0x01, 0x01, 0 }, { 0x0E, 0x07 }, kDescStateNoTransition,    0, ApplDescSecurityAccessRequestSeedVariantCoding } /* $27 $3 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x0E, 0x07 },                      6,    0, ApplDescSecurityAccessSendKeyVariantCoding } /* $27 $4 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    4, DescOemControlEnableRxAndTx } /* $28 $0 $3 */, 
  {   3, { 0x03, 0x03, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    4, DescOemControlEnableRxAndDisableTx } /* $28 $1 $3 */, 
  {  18, { 0x01, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescWrite_2101_Variant_Coding_Programmed } /* $2E $21 $1 */, 
  {  25, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteF080_Authentication_Zone } /* $2E $F0 $80 */, 
  {  26, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteF08F_EMC_Standardization_Label } /* $2E $F0 $8F */, 
  {  27, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteF0FE_Identification_Zone } /* $2E $F0 $FE */, 

  {   6, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteF18B_ECUManufacturingDateDataIdentifier } /* $2E $F1 $8B */, 
  {  16, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteF18C_ECUSerialNumberDataIdentifier } /* $2E $F1 $8C */, 
  {   7, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD02_Serial_Communication_Service_Active_Defeats } /* $2E $FD $2 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD07_End_of_Line_Polarity } /* $2E $FD $7 */, 
  {  31, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD12_Current_Mode_Offset_and_Gain } /* $2E $FD $12 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD19_Nexteer_Manufacturing_Enable_Counter_MEC } /* $2E $FD $19 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD1B_Manual_Vehicle_speed_Overide } /* $2E $FD $1B */, 
  {   5, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD1E_Torque_Sensor_Diagnostic_Defeat } /* $2E $FD $1E */, 

  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD21_Vehicle_Tuning_Select } /* $2E $FD $21 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD23_Turns_Counter_Energy_Mode } /* $2E $FD $23 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD25_Motor_Torque_Scale_Factor } /* $2E $FD $25 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD26_Average_Friction_Learning_Select } /* $2E $FD $26 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD27_Friction_Offset_Output_Defeat } /* $2E $FD $27 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD29_Set_EOL_Friction_Learned } /* $2E $FD $29 */, 
  {   8, { 0x01, 0x01, 0 }, { 0x0F, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFD30_End_of_Line_Torque_Trim_Value_Digital_SENT } /* $2E $FD $30 */, 
  {   7, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDA1_ECU_Serial_Number } /* $2E $FD $A1 */, 

  {   7, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDA2_EPS_Serial_Number } /* $2E $FD $A2 */, 
  {  15, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDA3_ECU_Hardware_Part_Number } /* $2E $FD $A3 */, 
  {  67, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDAC_Nexteer_Manufacturing_Scratchpad } /* $2E $FD $AC */, 
  {   5, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDAE_Ignition_Counter } /* $2E $FD $AE */, 
  { 259, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDB0_IPM_Cogging_Table_1 } /* $2E $FD $B0 */, 
  { 259, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDB1_IPM_Cogging_Table_2 } /* $2E $FD $B1 */, 
  { 259, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDB2_IPM_Cogging_Table_3 } /* $2E $FD $B2 */, 
  { 259, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDB3_IPM_Cogging_Table_4 } /* $2E $FD $B3 */, 

  {  11, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDB4_Current_Mode_Analog_Ke_R_Ld_Lq } /* $2E $FD $B4 */, 
  {   7, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDB5_Active_Pull_Set_Short_Term_Comp } /* $2E $FD $B5 */, 
  {   7, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDB6_Active_Pull_Set_LongTerm_Comp } /* $2E $FD $B6 */, 
  {  21, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFDB7_IPM_Cogging_Table_5 } /* $2E $FD $B7 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescWriteFEFF_Application_Key } /* $2E $FE $FF */, 
  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescReturnControlFD0D_Motor_Torque_Command_I_O_Control } /* $2F $FD $D $0 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescSetFD0D_Motor_Torque_Command_I_O_Control } /* $2F $FD $D $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescReturnControlFD11_Assist_Gain_Command_I_O_Control } /* $2F $FD $11 $0 */, 

  {   6, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescSetFD11_Assist_Gain_Command_I_O_Control } /* $2F $FD $11 $3 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescStart_0400_Positioning_of_Power_Latch } /* $31 $1 $4 $0 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescStartDF00_Permanent_Control } /* $31 $1 $DF $0 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescStartDF01_Temporary_Control } /* $31 $1 $DF $1 */, 
  {   7, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescStartF000_Manufacturing_Variables_Reset } /* $31 $1 $F0 $0 */, 
  {   6, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescStartF001_Clear_Diagnostic_Trouble_Code_NTC_CTC } /* $31 $1 $F0 $1 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescStartF003_Position_Sensor_EOLCalibration } /* $31 $1 $F0 $3 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescStartF004_Torque_Sensor_End_Of_Line_Calibration_Digital } /* $31 $1 $F0 $4 */, 

  {   6, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescStartF005_DTC_Status_By_Number } /* $31 $1 $F0 $5 */, 
  {   5, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescStartF008_Current_Mode_Current_Gain_Calc } /* $31 $1 $F0 $8 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescStartF009_Current_Mode_Current_Offset_Calc } /* $31 $1 $F0 $9 */, 
  {  10, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescStartF0FF_MPU_Test_Interface } /* $31 $1 $F0 $FF */, 
  {   4, { 0x01, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescStop_0400_Positioning_of_Power_Latch } /* $31 $2 $4 $0 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescStopDF00_Permanent_Control } /* $31 $2 $DF $0 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescStopDF01_Temporary_Control } /* $31 $2 $DF $1 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescStopF009_Current_Mode_Current_Offset_Calc } /* $31 $2 $F0 $9 */, 

  {   4, { 0x01, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescResults_0400_Positioning_of_Power_Latch } /* $31 $3 $4 $0 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescResultsDF00_Permanent_Control } /* $31 $3 $DF $0 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescResultsDF01_Temporary_Control } /* $31 $3 $DF $1 */, 
  {   4, { 0x01, 0x01, 0 }, { 0x08, 0x07 }, kDescStateNoTransition,    0, ApplDescResultsF009_Current_Mode_Current_Offset_Calc } /* $31 $3 $F0 $9 */, 
  {   2, { 0x03, 0x03, 0 }, { 0x1F, 0x07 }, kDescStateNoTransition,    0, DescGenSendTesterPresent } /* $3E $0 */, 
  {   5, { 0x03, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescControlDTCSettingOn } /* $85 $1 */, 
  {   5, { 0x03, 0x01, 0 }, { 0x0C, 0x07 }, kDescStateNoTransition,    0, ApplDescControlDTCSettingOff } /* $85 $2 */
};
...
V_MEMROM0 static V_MEMROM1 DescMsgItem V_MEMROM2 g_descSvcInstHeadExt[kDescSvcInstHeadExtNumItems] = 
{
  ...
  0x21, 0x01, 0xF0, 0x80, 0xF0, 0x8F, 0xF0, 0xFE, 0xF1, 0x8B, 0xF1, 0x8C, 0xFD, 0x02, 0xFD, 0x07 /* $2E */, 
  0xFD, 0x12, 0xFD, 0x19, 0xFD, 0x1B, 0xFD, 0x1E, 0xFD, 0x21, 0xFD, 0x23, 0xFD, 0x25, 0xFD, 0x26 /* $2E */, 
  0xFD, 0x27, 0xFD, 0x29, 0xFD, 0x30, 0xFD, 0xA1, 0xFD, 0xA2, 0xFD, 0xA3, 0xFD, 0xAC, 0xFD, 0xAE /* $2E */, 

  0xFD, 0xB0, 0xFD, 0xB1, 0xFD, 0xB2, 0xFD, 0xB3, 0xFD, 0xB4, 0xFD, 0xB5, 0xFD, 0xB6, 0xFD, 0xB7 /* $2E */, 
  0xFE, 0xFF /* $2E */, 
  0xFD, 0x0D, 0x00, 0xFD, 0x0D, 0x03, 0xFD, 0x11, 0x00, 0xFD, 0x11, 0x03 /* $2F */, 
  0x01, 0x04, 0x00, 0x01, 0xDF, 0x00, 0x01, 0xDF, 0x01, 0x01, 0xF0, 0x00, 0x01, 0xF0, 0x01, 0x01, 0xF0, 0x03 /* $31 */, 
  0x01, 0xF0, 0x04, 0x01, 0xF0, 0x05, 0x01, 0xF0, 0x08, 0x01, 0xF0, 0x09, 0x01, 0xF0, 0xFF, 0x02, 0x04, 0x00 /* $31 */, 
  0x02, 0xDF, 0x00, 0x02, 0xDF, 0x01, 0x02, 0xF0, 0x09, 0x03, 0x04, 0x00, 0x03, 0xDF, 0x00, 0x03, 0xDF, 0x01 /* $31 */, 
  0x03, 0xF0, 0x09 /* $31 */, 
  0x00 /* $3E */, 
...
{
  { 0x0100,    1, { { 0x0C, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescRead_0100_Powerlatch_Flag_State }, 
  { 0x0D01,    1, { { 0x0F, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescRead_0D01_Size_ECUSerialNumberDataIdentifier }, 
  { 0x2100,   16, { { 0x0D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescRead_2100_Variant_Coding_Possibilities }, 
  { 0x2101,   15, { { 0x0D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescRead_2101_Variant_Coding_Programmed }, 
  { 0xC002,    2, { { 0x0D, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadC002_Size_for_Multi }, 
  { 0xD403,    2, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD403_Vehicle_Speed }, 
  { 0xD404,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD404_Battery_Voltage }, 
  { 0xD405,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD405_ECU_Temperature }, 

  { 0xD407,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD407_Engine_State }, 
  { 0xD408,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD408_Ignition_On_Off }, 
  { 0xD409,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD409_Assist_State }, 
  { 0xD40A,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD40A_Assist_Mode }, 
  { 0xD40C,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD40C_State_Mode }, 
  { 0xD40D,    2, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD40D_Absolute_Handwheel_Angle }, 
  { 0xD40E,    2, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD40E_Handwheel_Angle }, 
  { 0xD40F,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD40F_Handwheel_Torque }, 

  { 0xD410,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD410_Final_Torque_Command }, 
  { 0xD412,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD412_Derating_Flag }, 
  { 0xD413,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD413_DMD_FCT_CPK }, 
  { 0xD414,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD414_CAUSE_DESACTIV_CPK }, 
  { 0xD415,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD415_ETAT_DAE_CPK }, 
  { 0xD417,    2, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD417_Steering_Wheel_Angle_Setpoint }, 
  { 0xD418,    2, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD418_Handwheel_Velocity }, 
  { 0xD419,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD419_LKA_Function_Request }, 

  { 0xD41A,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD41A_LXA_Trajectory_Correction_Factor }, 
  { 0xD41B,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD41B_EPS_State_LXA }, 
  { 0xD41C,    1, { { 0x1D, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadD41C_Active_Tuning_Set }, 
  { 0xF080,   22, { { 0x1F, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadF080_Authentication_Zone }, 
  { 0xF08A,   68, { { 0x0D, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadF08A_Multiplexed_CAN_HS_Network_Diagnostic }, 
  { 0xF08F,   23, { { 0x0F, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadF08F_EMC_Standardization_Label }, 
  { 0xF0FE,   24, { { 0x0F, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadF0FE_Identification_Zone }, 
  { 0xF180,   13, { { 0x0F, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadF180_bootSoftwareIdentification }, 

  { 0xF186,    1, { { 0x0F, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadF186_ActiveDiagnosticSessionControl }, 
  { 0xF18B,    3, { { 0x0F, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadF18B_ECUManufacturingDateDataIdentifier }, 
  { 0xF18C,   13, { { 0x0F, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadF18C_ECUSerialNumberDataIdentifier }, 
  { 0xFD01,    0, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD01_Internal_Software_Identifiers }, 
  { 0xFD02,    4, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD02_Serial_Communication_Service_Active_Defeats }, 
  { 0xFD07,    1, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD07_End_of_Line_Polarity }, 
  { 0xFD0E,    8, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD0E_Motor_Stiffness_Check }, 
  { 0xFD10,   10, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD10_Nexteer_CCP_XCP_Transmit_and_Receive_IDs }, 

  { 0xFD12,   28, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD12_Current_Mode_Offset_and_Gain }, 
  { 0xFD13,   75, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD13_Read_Nexteer_DTCs }, 
  { 0xFD14,    2, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadNexteer_FD13_Read_Nexteer_DTCs_1 }, 
  { 0xFD17,    2, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD17_Flash_Memory_Size }, 
  { 0xFD19,    1, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD19_Nexteer_Manufacturing_Enable_Counter_MEC }, 
  { 0xFD1A,    1, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD1A_System_state }, 
  { 0xFD1B,    1, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD1B_Manual_Vehicle_speed_Overide }, 
  { 0xFD1C,    3, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD1C_Manufacturing_Services_Version }, 

  { 0xFD1E,    2, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD1E_Torque_Sensor_Diagnostic_Defeat }, 
  { 0xFD20,    3, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD20_Read_Transient_Overvoltage_Data }, 
  { 0xFD21,    1, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD21_Vehicle_Tuning_Select }, 
  { 0xFD23,    1, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD23_Turns_Counter_Energy_Mode }, 
  { 0xFD25,    2, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD25_Motor_Torque_Scale_Factor }, 
  { 0xFD26,    3, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD26_Average_Friction_Learning_Select }, 
  { 0xFD27,    1, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD27_Friction_Offset_Output_Defeat }, 
  { 0xFD29,    2, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD29_Set_EOL_Friction_Learned }, 

  { 0xFD30,    5, { { 0x1F, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadFD30_End_of_Line_Torque_Trim_Value_Digital_SENT }, 
  { 0xFD31,   12, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFD31_Torque_Sensor_Value_Digital_SENT }, 
  { 0xFDA1,    4, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDA1_ECU_Serial_Number }, 
  { 0xFDA2,    4, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDA2_EPS_Serial_Number }, 
  { 0xFDA3,   12, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDA3_ECU_Hardware_Part_Number }, 
  { 0xFDAC,   64, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDAC_Nexteer_Manufacturing_Scratchpad }, 
  { 0xFDAD,    7, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDAD_Active_Pull_Compensation }, 
  { 0xFDAE,    2, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDAE_Ignition_Counter }, 

  { 0xFDAF,  176, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDAF_NTC_Snapshot_Data }, 
  { 0xFDB0,  256, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDB0_IPM_Cogging_Table_1 }, 
  { 0xFDB1,  256, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDB1_IPM_Cogging_Table_2 }, 
  { 0xFDB2,  256, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDB2_IPM_Cogging_Table_3 }, 
  { 0xFDB3,  256, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDB3_IPM_Cogging_Table_4 }, 
  { 0xFDB4,    8, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDB4_Current_Mode_Analog_Ke_R_Ld_Lq }, 
  { 0xFDB5,    4, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDB5_Active_Pull_Set_Short_Term_Comp }, 
  { 0xFDB6,    4, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDB6_Active_Pull_Set_LongTerm_Comp }, 

  { 0xFDB7,   18, { { 0x08, 0x07 }, { 0x03, 0x03, 0 } }, ApplDescReadFDB7_IPM_Cogging_Table_5 }, 
  { 0xFEFE,   56, { { 0x0A, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadFEFE_Nexteer_Flash_Bootloader_Identification }, 
  { 0xFEFF,    2, { { 0x08, 0x07 }, { 0x01, 0x01, 0 } }, ApplDescReadFEFF_Application_Key }
};
