 ...
 *  Generated at:  Fri May 20 11:58:48 2016
 *
 ...
 * --------   -------  -------  ------------------------------------------------------------------------------  -------
 * 10/03/14    1       OT       Initial version (based on DiagSvc.c v3)                                          12363
 * 11/13/14    2       OT       Implemented D40A                                                                 12714
 * 07/07/15    3       OT       Corrected temperature offset                                                     13472
 * 07/16/15    4       OT       Updates for SCIR 003B                                                            13475
 * 09/17/15    5       OT       Added rounding factors for values in scientific units                         EA3#2929
 * 05/19/15    6       WH       Updated the Tuning select default value for new tuning select members.        EA3#7995
 * 05/19/16    7       WH       Updated snapshot data for DSR4A                                               EA3#7995
 * 11/15/16    8       WH       Updated the Tuning select default values                                      EA3#12635
 */
/**********************************************************************************************************************
 ...
 *********************************************************************************************************************/
	...
	Rte_Read_Mileage_Cnt_u32(&Mileage_Cnt_T_u32); /* PRQA S 3200 */
	
    Mileage_Cnt_T_u32 = Limit_m(Mileage_Cnt_T_u32, MinMileageVal, MaxMileageVal);
	(*Data)[0u] = HierByte(Mileage_Cnt_T_u32);
 ...
 *********************************************************************************************************************/
	...
	Rte_Read_SrlComVehSpd_Kph_f32(&SrlComVehSpd_Kph_T_f32); /* PRQA S 3200 */
	Rte_Read_VehicleSpeedValid_Cnt_lgc(&VehicleSpeedValid_Cnt_T_lgc); /* PRQA S 3200 */
	...
	(*Data)[0u] = HiByte(VehicleSpeed_Cnt_T_u16);
 ...
 *********************************************************************************************************************/
	...
	Rte_Read_ECUTemperature_DegC_f32(&ECUTemperature_DegC_T_f32); /* PRQA S 3200 */
	Rte_Call_NxtrDiagMgr_GetNTCFailed(NTC_Num_Thermistor, &Thermister_Cnt_T_lgc); /* PRQA S 3200 */
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Read_AssistState_Cnt_u08(UInt8 *data)
 *
 * Mode Interfaces:
 * ================
 *   Rte_ModeType_StaMd_Mode Rte_Mode_SystemState_Mode(void)
 ...
 *********************************************************************************************************************/
	...
	VAR(uint8, AUTOMATIC) AssistState_Cnt_T_u08;
	
	Rte_Read_AssistState_Cnt_u08(&AssistState_Cnt_T_u08); /* PRQA S 3200 */
	
	(*Data)[0u] = AssistState_Cnt_T_u08;
 ...
 *********************************************************************************************************************/
	...
	for( i = 1u; (i < TableSize_m(k_FltRspTbl_Cnt_str)) && (NTCActive_Cnt_T_lgc == FALSE); i++ )
	{
		...
		{
			Rte_Call_NxtrDiagMgr_GetNTCActive(i, &NTCActive_Cnt_T_lgc); /* PRQA S 3200 */
	...
	(*Data)[0u] = HiByte(NTCNumber_Cnt_T_u16);
 ...
 *********************************************************************************************************************/
	...
	Rte_Read_HandwheelAngle_HwDeg_f32(&HandwheelAngle_HwDeg_T_f32); /* PRQA S 3200 */
	Rte_Read_HandwheelAuthority_Uls_f32(&HandwheelAuthority_Uls_T_f32); /* PRQA S 3200 */
	...
	(*Data)[0u] = HiByte(HandwheelAngle_Cnt_T_u16);
 ...
 *********************************************************************************************************************/
	...
	Rte_Read_SrlComHwTrqValid_Cnt_lgc(&SrlComHwTrqValid_Cnt_T_lgc); /* PRQA S 3200 */
 ...
 *********************************************************************************************************************/
	...
	Rte_Read_FinalTorqueCommand_MtrNm_f32(&FinalTorqueCommand_MtrNm_T_f32); /* PRQA S 3200 */
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Read_CAUSEDESACTIVCPK_Cnt_u08(UInt8 *data)
 *
 * Mode Interfaces:
 * ================
 *   Rte_ModeType_StaMd_Mode Rte_Mode_SystemState_Mode(void)
 ...
 *********************************************************************************************************************/
	...
	Rte_Read_CAUSEDESACTIVCPK_Cnt_u08(&CAUSEDESACTIVCPK_Cnt_T_u08); /* PRQA S 3200 */
	
	(*Data)[0u] = CAUSEDESACTIVCPK_Cnt_T_u08;
 ...
 *   Explicit S/R API:
 *   -----------------
 *   Std_ReturnType Rte_Read_ETATDAECPK_Cnt_u08(UInt8 *data)
 *
 * Mode Interfaces:
 * ================
 *   Rte_ModeType_StaMd_Mode Rte_Mode_SystemState_Mode(void)
 ...
 *********************************************************************************************************************/
	...
	Rte_Read_ETATDAECPK_Cnt_u08(&ETATDAECPK_Cnt_T_u08); /* PRQA S 3200 */
	
	(*Data)[0u] = ETATDAECPK_Cnt_T_u08;
 ...
 *********************************************************************************************************************/
	...
	Rte_Read_HandwheelVelocity_HwRadpS_f32(&HandwheelVelocity_HwRadpS_T_f32); /* PRQA S 3200 */
	...
	(*Data)[0u] = HiByte(HandwheelVelocity_Cnt_T_u16);
