 ...
 *  Generated at:  Fri May 20 11:58:28 2016
 *
 ...
 * API prototypes
 *********************************************************************************************************************/
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_Ap_DiagSvc_AssistState_Cnt_u08(P2VAR(UInt8, AUTOMATIC, RTE_AP_DIAGSVC_APPL_VAR) data);
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_Ap_DiagSvc_CAUSEDESACTIVCPK_Cnt_u08(P2VAR(UInt8, AUTOMATIC, RTE_AP_DIAGSVC_APPL_VAR) data);
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_Ap_DiagSvc_ETATDAECPK_Cnt_u08(P2VAR(UInt8, AUTOMATIC, RTE_AP_DIAGSVC_APPL_VAR) data);
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Read_Ap_DiagSvc_SrlComHwTrqValid_Cnt_lgc(P2VAR(Boolean, AUTOMATIC, RTE_AP_DIAGSVC_APPL_VAR) data);
...
#   if RTE_MAGIC_NUMBER != 1463749726
#    error "The magic number of the generated file <C:/synergy_projects_working/PSA/PSA_BMPV_EPS_TMS570/SwProject/DiagSvc/utp/contract/Ap_DiagSvc/Rte_Ap_DiagSvc.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1463749726
