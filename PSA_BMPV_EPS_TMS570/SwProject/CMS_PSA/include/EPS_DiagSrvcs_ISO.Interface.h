 ...
 * --------  -------  --------  ------------------------------------------------------------------------------  -------
 * 02/18/14   1       OT        Initial version
 * 05/19/14   2       OT        Added FDB7
 * 05/20/14   3       OT        Update for DigMSB v6
 * 07/24/14   4       OT        Updated to 07A.7
 * 08/12/14   5       OT        Updated to 07B.0 for DigHwTrqSENT v7                                             12256
 * 08/26/14   6       OT        Updates for new MPU configuration                                                12249
 * 10/15/14   7       OT        Added XCP variables                                                              12542
 * 10/31/14   8       OT        Enabled F0FF                                                                     12655
 */
...
#define CM_T1_Trim_Volts_Digital              &Rte_Nhet1_DigHwTrqT1_HwNm_f32
#define CM_T2_Trim_Volts_Digital              &Rte_Nhet1_DigHwTrqT2_HwNm_f32
...
#define CM_NvMP_Rte_DigMSB_DigMSBEOLData      &NvMP_Rte_DigMSB_DigMSBEOLData
/* -----[ End XCP Variables ]----- */
