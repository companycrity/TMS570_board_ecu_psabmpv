...
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_DigMSB_DigMSBEOLData[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_AstLmt_SteerAsstDefeat[];
...
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_ThrmlDutyCycle_ThrmlDutyCycle_FltStVal[];
...
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_VehDyn_MotPosReset[];
...
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_SrlComInput_VVHTYPEData[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_SrlComInput_ElecIntData[];
extern VAR(uint8, NVM_APPL_DATA) TuningSelect_G_str[];
extern CONST(uint8, NVM_APPL_CONST) D_TUNINGSELECTINIT_CNT_STR[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_DigHwTrqSENT_DigTrqTrim[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_CmMtrCurr_ShCurrCal[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_TrqCanc_CogTrqCal[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_TrqCanc_CogTrqRplComp[];
...
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_AvgFricLrn_AvgFricLrnData[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_CmMtrCurr_CurrTempOffset[];
extern VAR(uint8, NVM_APPL_DATA) Rte_FaultLog_FaultLog[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_SrlComInput_ShutdownTimeData[];
extern VAR(uint8, NVM_APPL_DATA) NvMP_Rte_AbsHwPos_EOLVehCntrOffset[];
...
#include "MemMap.h"
    ...
    /* block descriptor user block Rte_NvmBlock_DigMSB_DigMSBEOLData */
    ,{
        (NvM_RamAddressType)&NvMP_Rte_DigMSB_DigMSBEOLData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_AstLmt_SteerAsstDefeat */
    ,{
        (NvM_RamAddressType)&NvMP_Rte_AstLmt_SteerAsstDefeat /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_ThrmlDutyCycle_ThrmlDutyCycle_FltStVal /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_VehDyn_MotPosReset /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_SrlComInput_VVHTYPEData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_SrlComInput_ElecIntData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    /* block descriptor user block Rte_NvmBlock_DigHwTrqSENT_DigTrqTrim */
    ,{
        (NvM_RamAddressType)&NvMP_Rte_DigHwTrqSENT_DigTrqTrim /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        ...
        30u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
        NVM_BLOCK_NATIVE,/* Management Type */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_TrqCanc_CogTrqCal /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0048u,     /* NV block Base number (defined by FEE/EA) */
        1026u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
        NVM_BLOCK_NATIVE,/* Management Type */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_TrqCanc_CogTrqRplComp /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_AvgFricLrn_AvgFricLrnData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
        0x0052u,     /* NV block Base number (defined by FEE/EA) */
        206u,    /* Length of the block in bytes */
        1u,    /* Number of multiple blocks (depends on Mngmt type) */
        127u,/* Block Priority */
        MEMIF_Fee,                                 /* Device Id (defined by MemIf) */
        NVM_BLOCK_NATIVE,/* Management Type */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_CmMtrCurr_CurrTempOffset /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_SrlComInput_ShutdownTimeData /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
    ...
    ,{
        (NvM_RamAddressType)&NvMP_Rte_AbsHwPos_EOLVehCntrOffset /* pointer to the RAM data buffer */,
        NULL_PTR /* no ROM default data block */,
        NULL_PTR, /* no Job End notification callback */
        NULL_PTR, /* Pointer to the CRC buffer */
