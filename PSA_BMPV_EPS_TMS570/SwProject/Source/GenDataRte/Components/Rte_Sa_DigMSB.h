...
#  define Rte_IWrite_DigMSB_Per2_AlignedCumMechMtrPosCRF_Deg_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_DigMSB_DigMSB_Per2.Rte_AlignedCumMechMtrPosCRF_Deg_f32.value = (data) \
  )

#  define Rte_IWriteRef_DigMSB_Per2_AlignedCumMechMtrPosCRF_Deg_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_DigMSB_DigMSB_Per2.Rte_AlignedCumMechMtrPosCRF_Deg_f32.value)
...
#  define Rte_IWrite_DigMSB_Per2_AlignedCumMechMtrPosStatus_Cnt_u08(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Sa_DigMSB_DigMSB_Per2.Rte_AlignedCumMechMtrPosStatus_Cnt_u08.value = (data) \
  )

#  define Rte_IWriteRef_DigMSB_Per2_AlignedCumMechMtrPosStatus_Cnt_u08() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Sa_DigMSB_DigMSB_Per2.Rte_AlignedCumMechMtrPosStatus_Cnt_u08.value)
...
#  define Rte_IWrite_DigMSB_Per2_CumMechMtrPosStatus_Cnt_u08(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_DigMSB_CumMechMtrPosStatus_Cnt_u08.value = (data) \
  )
