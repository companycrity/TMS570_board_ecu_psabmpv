...
#  define Rte_IRead_PosServo_Per1_HandwheelPosition_HwDeg_f32() \
  (Rte_Task_2ms_9.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_HandwheelPosition_HwDeg_f32.value)
...
#  define Rte_IRead_PosServo_Per1_PosSrvoEnable_Cnt_lgc() \
  (Rte_Task_2ms_9.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_PosSrvoEnable_Cnt_lgc.value)

#  define Rte_IRead_PosServo_Per1_PosSrvoHwAngle_HwDeg_f32() \
  (Rte_Task_2ms_9.Rte_RB.Rte_Ap_PosServo_PosServo_Per1.Rte_PosSrvoHwAngle_HwDeg_f32.value)
