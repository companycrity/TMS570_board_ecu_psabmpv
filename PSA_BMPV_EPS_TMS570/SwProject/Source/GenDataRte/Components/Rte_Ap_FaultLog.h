...
#  define Rte_Read_Ap_FaultLog_EngineState_Cnt_u08(data) (*(data) = Rte_SrlComDriver_EtatMT_Cnt_u08, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_EtatPrincipSev_Cnt_u08 Rte_Read_Ap_FaultLog_EtatPrincipSev_Cnt_u08
#  define Rte_Read_Ap_FaultLog_EtatPrincipSev_Cnt_u08(data) (*(data) = Rte_SrlComDriver_EtatPrincipSev_Cnt_u08, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_EtatReseauElec_Cnt_u08 Rte_Read_Ap_FaultLog_EtatReseauElec_Cnt_u08
#  define Rte_Read_Ap_FaultLog_EtatReseauElec_Cnt_u08(data) (*(data) = Rte_SrlComDriver_EtatReseauElec_Cnt_u08, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_HandwheelPosition_HwDeg_f32 Rte_Read_Ap_FaultLog_HandwheelPosition_HwDeg_f32
#  define Rte_Read_Ap_FaultLog_HandwheelPosition_HwDeg_f32(data) (*(data) = Rte_AbsHwPos_HandwheelPosition_HwDeg_f32, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Read_Ap_FaultLog_Kilometrage_Cnt_u32(data) (*(data) = Rte_SrlComDriver_Kilometrage_Cnt_u32, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Read_Ap_FaultLog_PowerSupplies_Cnt_u08(data) (*(data) = Rte_SrlComDriver_PowerSupplies_Cnt_u08, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_ShuntPosition_Cnt_u08 Rte_Read_Ap_FaultLog_ShuntPosition_Cnt_u08
#  define Rte_Read_Ap_FaultLog_ShuntPosition_Cnt_u08(data) (*(data) = Rte_SrlComDriver_ShuntPosition_Cnt_u08, ((Std_ReturnType)RTE_E_OK))
