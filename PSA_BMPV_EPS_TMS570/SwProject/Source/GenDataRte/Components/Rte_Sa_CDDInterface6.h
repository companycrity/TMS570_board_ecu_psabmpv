...
#  define Rte_IWrite_CDDInterface6_Init1_CAVHCSelected_Cnt_lgc(data) \
  ( \
    Rte_Task_Init_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Init1.Rte_CAVHCSelected_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_CDDInterface6_Init1_CAVHCSelected_Cnt_lgc() \
  (&Rte_Task_Init_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Init1.Rte_CAVHCSelected_Cnt_lgc.value)

#  define Rte_IWrite_CDDInterface6_Init1_CityParkSelected_Cnt_lgc(data) \
  ( \
    Rte_Task_Init_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Init1.Rte_CityParkSelected_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_CDDInterface6_Init1_CityParkSelected_Cnt_lgc() \
  (&Rte_Task_Init_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Init1.Rte_CityParkSelected_Cnt_lgc.value)

#  define Rte_IWrite_CDDInterface6_Init1_LXASelected_Cnt_lgc(data) \
  ( \
    Rte_Task_Init_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Init1.Rte_LXASelected_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_CDDInterface6_Init1_LXASelected_Cnt_lgc() \
  (&Rte_Task_Init_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Init1.Rte_LXASelected_Cnt_lgc.value)

#  define Rte_IWrite_CDDInterface6_Init1_MultiModeSelected_Cnt_lgc(data) \
  ( \
    Rte_Task_Init_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Init1.Rte_MultiModeSelected_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_CDDInterface6_Init1_MultiModeSelected_Cnt_lgc() \
  (&Rte_Task_Init_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Init1.Rte_MultiModeSelected_Cnt_lgc.value)

#  define Rte_IWrite_CDDInterface6_Init1_STTdSelected_Cnt_lgc(data) \
  ( \
    Rte_Task_Init_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Init1.Rte_STTdSelected_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_CDDInterface6_Init1_STTdSelected_Cnt_lgc() \
  (&Rte_Task_Init_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Init1.Rte_STTdSelected_Cnt_lgc.value)
...
#  define Rte_IWrite_CDDInterface6_Per1_EnergyModeState_Cnt_enum(data) \
  ( \
    Rte_Task_10ms_6.Rte_RB.Rte_Sa_CDDInterface6_CDDInterface6_Per1.Rte_EnergyModeState_Cnt_enum.value = (data) \
  )
