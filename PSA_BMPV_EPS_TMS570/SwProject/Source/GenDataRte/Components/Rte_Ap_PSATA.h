...
#  define Rte_IWrite_PSATA_Per1_PosSrvoNTC_Cnt_lgc(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_PSATA_PSATA_Per1.Rte_PosSrvoNTC_Cnt_lgc.value = (data) \
  )

#  define Rte_IWriteRef_PSATA_Per1_PosSrvoNTC_Cnt_lgc() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_PSATA_PSATA_Per1.Rte_PosSrvoNTC_Cnt_lgc.value)
