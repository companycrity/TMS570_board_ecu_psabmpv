...
#  define Rte_IWrite_CDDInterface9_Per1_MeasuredOnTimeA_Cnt_u32(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Sa_CDDInterface9_CDDInterface9_Per1.Rte_MeasuredOnTimeA_Cnt_u32.value = (data) \
  )

#  define Rte_IWriteRef_CDDInterface9_Per1_MeasuredOnTimeA_Cnt_u32() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Sa_CDDInterface9_CDDInterface9_Per1.Rte_MeasuredOnTimeA_Cnt_u32.value)

#  define Rte_IWrite_CDDInterface9_Per1_MeasuredOnTimeB_Cnt_u32(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Sa_CDDInterface9_CDDInterface9_Per1.Rte_MeasuredOnTimeB_Cnt_u32.value = (data) \
  )

#  define Rte_IWriteRef_CDDInterface9_Per1_MeasuredOnTimeB_Cnt_u32() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Sa_CDDInterface9_CDDInterface9_Per1.Rte_MeasuredOnTimeB_Cnt_u32.value)

#  define Rte_IWrite_CDDInterface9_Per1_MeasuredOnTimeC_Cnt_u32(data) \
  ( \
    Rte_Task_2ms_9.Rte_RB.Rte_Sa_CDDInterface9_CDDInterface9_Per1.Rte_MeasuredOnTimeC_Cnt_u32.value = (data) \
  )

#  define Rte_IWriteRef_CDDInterface9_Per1_MeasuredOnTimeC_Cnt_u32() \
  (&Rte_Task_2ms_9.Rte_RB.Rte_Sa_CDDInterface9_CDDInterface9_Per1.Rte_MeasuredOnTimeC_Cnt_u32.value)
