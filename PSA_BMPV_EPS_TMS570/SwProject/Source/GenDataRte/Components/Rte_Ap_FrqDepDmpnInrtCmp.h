...
#  define Rte_IRead_FrqDepDmpnInrtCmp_Per1_FreqDepDmpSrlComSvcDft_Cnt_lgc() \
  (Rte_Task_2ms_10.Rte_TB.Rte_I_CDDInterface6_FreqDepDmpSrlComSvcDft_Cnt_lgc.value)
...
#  define Rte_IWrite_FrqDepDmpnInrtCmp_Per1_FrqDepDmpnInrtCmp_MtrNm_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_TB.Rte_I_FrqDepDmpnInrtCmp_FrqDepDmpnInrtCmp_MtrNm_f32.value = (data) \
  )

#  define Rte_IWriteRef_FrqDepDmpnInrtCmp_Per1_FrqDepDmpnInrtCmp_MtrNm_f32() \
  (&Rte_Task_2ms_10.Rte_TB.Rte_I_FrqDepDmpnInrtCmp_FrqDepDmpnInrtCmp_MtrNm_f32.value)
