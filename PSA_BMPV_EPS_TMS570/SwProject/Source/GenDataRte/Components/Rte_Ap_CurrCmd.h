...
#  define Rte_IWrite_CurrCmd_Per1_MtrTrqCmdSign_Cnt_s16(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrTrqCmdSign_Cnt_s16.value = (data) \
  )

#  define Rte_IWriteRef_CurrCmd_Per1_MtrTrqCmdSign_Cnt_s16() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrTrqCmdSign_Cnt_s16.value)

#  define Rte_IWrite_CurrCmd_Per1_MtrVoltDaxFF_Volt_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrVoltDaxFF_Volt_f32.value = (data) \
  )

#  define Rte_IWriteRef_CurrCmd_Per1_MtrVoltDaxFF_Volt_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrVoltDaxFF_Volt_f32.value)

#  define Rte_IWrite_CurrCmd_Per1_MtrVoltQaxFF_Volt_f32(data) \
  ( \
    Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrVoltQaxFF_Volt_f32.value = (data) \
  )

#  define Rte_IWriteRef_CurrCmd_Per1_MtrVoltQaxFF_Volt_f32() \
  (&Rte_Task_2ms_10.Rte_RB.Rte_Ap_CurrCmd_CurrCmd_Per1.Rte_MtrVoltQaxFF_Volt_f32.value)
