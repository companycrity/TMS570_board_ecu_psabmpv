...
/************************************************************************/
extern VAR(UInt8, RTE_VAR_INIT) Rte_SrlComOutput_ETATASSISTDA_Cnt_u08;
extern VAR(Float, RTE_VAR_INIT) Rte_IoHwAb10_Batt_Volt_f32;
extern VAR(UInt8, RTE_VAR_INIT) Rte_SrlComOutput_CAUSEDESACTIVCPK_Cnt_u08;
extern VAR(Float, RTE_VAR_INIT) Rte_CtrlTemp_FiltMeasTemp_DegC_f32;
extern VAR(UInt8, RTE_VAR_INIT) Rte_SrlComOutput_ETATDAECPK_Cnt_u08;
...
extern VAR(Boolean, RTE_VAR_INIT) Rte_DigHwTrqSENT_SrlComHwTrqValid_Cnt_lgc;
...
#  define Rte_InitValue_AssistState_Cnt_u08 (0U)
...
#  define Rte_InitValue_EPSStateLKA_Cnt_u08 (0U)
 ...
 *********************************************************************************************************************/
#  define Rte_Read_AssistState_Cnt_u08 Rte_Read_Ap_DiagSvc_AssistState_Cnt_u08
#  define Rte_Read_Ap_DiagSvc_AssistState_Cnt_u08(data) (*(data) = Rte_SrlComOutput_ETATASSISTDA_Cnt_u08, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Read_CAUSEDESACTIVCPK_Cnt_u08 Rte_Read_Ap_DiagSvc_CAUSEDESACTIVCPK_Cnt_u08
#  define Rte_Read_Ap_DiagSvc_CAUSEDESACTIVCPK_Cnt_u08(data) (*(data) = Rte_SrlComOutput_CAUSEDESACTIVCPK_Cnt_u08, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Read_ETATDAECPK_Cnt_u08 Rte_Read_Ap_DiagSvc_ETATDAECPK_Cnt_u08
#  define Rte_Read_Ap_DiagSvc_ETATDAECPK_Cnt_u08(data) (*(data) = Rte_SrlComOutput_ETATDAECPK_Cnt_u08, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_EngineState_Cnt_u08 Rte_Read_Ap_DiagSvc_EngineState_Cnt_u08
#  define Rte_Read_Ap_DiagSvc_EngineState_Cnt_u08(data) (*(data) = Rte_SrlComDriver_EtatMT_Cnt_u08, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Read_Ap_DiagSvc_HandwheelAngle_HwDeg_f32(data) (*(data) = Rte_AbsHwPos_HandwheelPosition_HwDeg_f32, ((Std_ReturnType)RTE_E_OK))
#  define Rte_Read_HandwheelAuthority_Uls_f32 Rte_Read_Ap_DiagSvc_HandwheelAuthority_Uls_f32
#  define Rte_Read_Ap_DiagSvc_HandwheelAuthority_Uls_f32(data) (*(data) = Rte_AbsHwPos_HandwheelAuthority_Uls_f32, ((Std_ReturnType)RTE_E_OK))
...
#  define Rte_Read_SrlComHwTrqValid_Cnt_lgc Rte_Read_Ap_DiagSvc_SrlComHwTrqValid_Cnt_lgc
#  define Rte_Read_Ap_DiagSvc_SrlComHwTrqValid_Cnt_lgc(data) (*(data) = Rte_DigHwTrqSENT_SrlComHwTrqValid_Cnt_lgc, ((Std_ReturnType)RTE_E_OK))
