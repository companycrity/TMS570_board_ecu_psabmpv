 ...
 *     SW-C Type:  NtWrap
 *  Generated at:  Thu Oct  9 14:32:56 2014
 *
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NtWrap_C_DigHwTrqSENT_SCom_ClrTrqTrim(void);
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NtWrap_C_DigHwTrqSENT_SCom_SetTrqTrim(void);
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NtWrap_C_DigHwTrqSENT_SCom_WriteData(Float HwTrqTrim_HwNm_f32);
...
FUNC(Std_ReturnType, RTE_CODE) Rte_Call_NtWrap_C_Polarity_SCom_SetPolarity(UInt8 Polarity_Cnt_T_b08);
...
# define Rte_Call_C_DigHwTrqSENT_SCom_ClrTrqTrim Rte_Call_NtWrap_C_DigHwTrqSENT_SCom_ClrTrqTrim
# define Rte_Call_C_DigHwTrqSENT_SCom_SetTrqTrim Rte_Call_NtWrap_C_DigHwTrqSENT_SCom_SetTrqTrim
# define Rte_Call_C_DigHwTrqSENT_SCom_WriteData Rte_Call_NtWrap_C_DigHwTrqSENT_SCom_WriteData
...
#   if RTE_MAGIC_NUMBER != 1412875171
#    error "The magic number of the generated file <C:/Users/nzx5jd/Desktop/DVOutput/NtWrap/Rte_NtWrap.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1412875171
