...
#    error "The magic number of the generated file <C:/synergy_projects/PSA3.5.1/PSA_BMPV_EPS_TMS570/SwProject/SrlComOutput/utp/contract/Ap_SrlComOutput/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
