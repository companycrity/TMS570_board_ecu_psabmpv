...
struct Rte_CDS_Ap_SrlComOutput
{
  ...
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ANGLECOLONNE_Cnt_u16;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_APAStateTransitionCause_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_APAState_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_AUTORARRETMOTDA_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_AVASelected_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_CAUSEDESACTIVCPK_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_CODEDEFAUT_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_CPLEVOLANTOPTMSE_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_CPLEVOLANT_Cnt_u08;
  ...
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_DDEREDEMDA_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_DefaultHwaSCommExportValue_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ETATASSISTDA_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ETATDA2004_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ETATDA2010_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ETATDADYN_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ETATDAECPK_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ETATLIGNEAPC_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ETATSECUANGLECOL_Cnt_u08;
  ...
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_ISDYNDAEFirstMessageSent_Cnt_lgc;
  ...
  P2VAR(Rte_DE_Float, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_RelHwPos_HwDeg_f32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_STATUSCONFABSENT_Cnt_u32;
  ...
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_AP_SRLCOMOUTPUT_APPL_VAR) SrlComOutput_Per1_VITESSECOLONNE_Cnt_u16;
...
#    error "The magic number of the generated file <C:/synergy_projects/PSA3.5.1/PSA_BMPV_EPS_TMS570/SwProject/SrlComOutput/utp/contract/Ap_SrlComOutput/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
