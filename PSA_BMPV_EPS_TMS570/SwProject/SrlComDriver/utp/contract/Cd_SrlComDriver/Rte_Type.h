...
struct Rte_CDS_Cd_SrlComDriver
{
  ...
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ANGLECOLONNE_Cnt_u16;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_AUTORARRETMOTDA_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_AnneeEcoule_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_BusOff_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_CAUSEDESACTIVCPK_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_CODEDEFAUT_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_CPLEVOLANTOPTMSE_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_CPLEVOLANT_Cnt_u08;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ColumnAngleSetpoint_Cnt_u16;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_CompteurTemporelVehicule_Cnt_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ComputerRazGCT_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_DDEREDEMDA_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_DiagIntegraElec_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_DiagMuxOn_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_DmdDelestDA_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ETATASSISTDA_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ETATDA2004_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ETATDA2010_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ETATDADYN_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ETATDAECPK_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ETATLIGNEAPC_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ETATSECUANGLECOL_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_EffacDefaultDiag_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ElectronicIntegration_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_EtatMT_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_EtatPrincipSev_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_EtatReseauElec_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDAT4V2BSI552MsgDLCError_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDAT4V2BSI552MsgRxTime_MSec_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDATBSI3F2MsgDLCError_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDATBSI3F2MsgRxTime_MSec_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDATBSI412MsgDLCError_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDATBSI412MsgRxTime_MSec_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDATBSI432MsgDLCError_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDATBSI432MsgRxTime_MSec_u32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDATDIRAMsgTxInProgress_Cnt_lgc;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDATDIRAMsgTxTime_MSec_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYN2CMMMsgDLCError_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYN2CMMMsgRxTime_MSec_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNAASMsgDLCError_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNAASMsgRxTime_MSec_u32;
  P2VAR(Rte_DE_CanMsgType, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNAASMsg_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNABRMsgDLCError_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNABRMsgRxTime_MSec_u32;
  P2VAR(Rte_DE_CanMsgType, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNABRMsg_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNCMM208MsgDLCError_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNCMM208MsgRxTime_MSec_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNCMM388MsgDLCError_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNCMM388MsgRxTime_MSec_u32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNDAEFirstMessageSent_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNVOLMsgDLCError_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNVOLMsgRxTime_MSec_u32;
  P2VAR(Rte_DE_CanMsgType, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISDYNVOLMsg_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ISINTEELECTRONBSIMsgRxTime_MSec_u32;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_JourEcoule_Cnt_u16;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_Kilometrage_Cnt_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_LKAState_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_LKATrqFactReq_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_LXAActivation_Cnt_u08;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_LXASelected_Cnt_lgc;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_MarcheARBVM_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ModeDiag_Cnt_u08;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_PowerSupplies_Cnt_u08;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_STATUSCONFABSENT_Cnt_u32;
  P2VAR(Rte_DE_Boolean, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_STTdSelected_Cnt_lgc;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_SecondeEcoulee_Cnt_u32;
  P2VAR(Rte_DE_UInt8, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_ShuntPosition_Cnt_u08;
  ...
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_VITESSECOLONNE_Cnt_u16;
  P2VAR(Rte_DE_UInt16, TYPEDEF, RTE_CD_SRLCOMDRIVER_APPL_VAR) SrlComDriver_Per1_VitesseVehicleBV_Cnt_u16;
...
#    error "The magic number of the generated file <C:/synergy_projects/PSA/PSA_BMPV_EPS_TMS570/SwProject/SrlComDriver/utp/contract/Cd_SrlComDriver/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
