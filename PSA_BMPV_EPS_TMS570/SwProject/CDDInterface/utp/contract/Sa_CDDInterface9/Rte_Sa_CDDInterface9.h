 ...
 *  Generated at:  Tue Mar 10 14:32:21 2015
 *
...
# define Rte_IWrite_CDDInterface9_Per1_MeasuredOnTimeA_Cnt_u32(data) \
  ( \
  Rte_Inst_Sa_CDDInterface9->CDDInterface9_Per1_MeasuredOnTimeA_Cnt_u32->value = (data) \
  )

# define Rte_IWriteRef_CDDInterface9_Per1_MeasuredOnTimeA_Cnt_u32() \
  (&Rte_Inst_Sa_CDDInterface9->CDDInterface9_Per1_MeasuredOnTimeA_Cnt_u32->value)

# define Rte_IWrite_CDDInterface9_Per1_MeasuredOnTimeB_Cnt_u32(data) \
  ( \
  Rte_Inst_Sa_CDDInterface9->CDDInterface9_Per1_MeasuredOnTimeB_Cnt_u32->value = (data) \
  )

# define Rte_IWriteRef_CDDInterface9_Per1_MeasuredOnTimeB_Cnt_u32() \
  (&Rte_Inst_Sa_CDDInterface9->CDDInterface9_Per1_MeasuredOnTimeB_Cnt_u32->value)

# define Rte_IWrite_CDDInterface9_Per1_MeasuredOnTimeC_Cnt_u32(data) \
  ( \
  Rte_Inst_Sa_CDDInterface9->CDDInterface9_Per1_MeasuredOnTimeC_Cnt_u32->value = (data) \
  )

# define Rte_IWriteRef_CDDInterface9_Per1_MeasuredOnTimeC_Cnt_u32() \
  (&Rte_Inst_Sa_CDDInterface9->CDDInterface9_Per1_MeasuredOnTimeC_Cnt_u32->value)
...
#   if RTE_MAGIC_NUMBER != 1426013276
#    error "The magic number of the generated file <C:/Users/nzx5jd/Desktop/DVOutput/Sa_CDDInterface9/Rte_Sa_CDDInterface9.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
#   define RTE_MAGIC_NUMBER 1426013276
