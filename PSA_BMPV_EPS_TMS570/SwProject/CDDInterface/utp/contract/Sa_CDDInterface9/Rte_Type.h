...
struct Rte_CDS_Sa_CDDInterface9
{
  ...
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MeasuredOnTimeA_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MeasuredOnTimeB_Cnt_u32;
  P2VAR(Rte_DE_UInt32, TYPEDEF, RTE_SA_CDDINTERFACE9_APPL_VAR) CDDInterface9_Per1_MeasuredOnTimeC_Cnt_u32;
...
#    error "The magic number of the generated file <C:/Users/nzx5jd/Desktop/DVOutput/Sa_CDDInterface9/Rte_Type.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
