...
#    error "The magic number of the generated file <C:/Synergy_EA3/working/VehDyn/tools/contract/Ap_VehDyn/Rte.h> is different. Please check time and date of the generated RTE files!"
#   endif
#  else
